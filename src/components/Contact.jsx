...
const Contact = () => {
  return (
    <div className='border-b border-neutral-900 pb-4' id="contact">
      <motion.h2 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} transition={{ duration: 0.5 }} className='my-10 md:my-20 text-center text-4xl text-blue-400 font-bold'>Get In Touch</motion.h2>
