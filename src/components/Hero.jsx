    ...
    <div className='border-b border-neutral-900 pb=4 lg:mb-35'>
        <div className='flex flex-wrap'>
            ...
            <div className='flex flex-col lg:items-start sm:items-center lg:ps-20 '>
                <motion.h1 variants={container(0)} initial="hidden" animate="visible" className='pb-16 font-medium tracking-tight lg:mt-16 text-8xl sm:text-center'>Nandish Patel</motion.h1>
