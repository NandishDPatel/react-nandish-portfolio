...
const MiniProjects = () => {
  return (
    <div className="border-b border-neutral-700 pb-4" id="miniprojects">
      <motion.h2
        whileInView={{ opacity: 1, y: 0 }}
        initial={{ opacity: 0, y: -100 }}
        transition={{ duration: 0.5 }}
        className="my-20 text-center text-4xl text-blue-400 border-b-green-400 font-bold"
      >
        Bootstrap Projects
      </motion.h2>
      <div className="mb-8 flex flex-wrap lg:justify-center">
        ...
        >
          <a
            href="https://nandishdpatel.github.io/PineVale-Website/"
            target="_blank"
          ...
          <a
            href="https://nandishdpatel.github.io/ToolM5-Website/"
            target="_blank"
            className="flex justify-center"
          >
          ...
          <a
            href="https://nandishdpatel.github.io/EduVibe-Website/"
            target="_blank"
            className="flex justify-center"
          >
