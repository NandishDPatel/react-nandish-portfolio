...
const CurricularActivities = () => {
    return (
        <div className='border-b border-neutral-900 pb-4'>
            <motion.h2 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} transition={{ duration: 0.5 }} className='my-20 text-center text-4xl'>Curricular Activities</motion.h2>
            <div>
                    ...
                    <div  className='mb-8 flex flex-wrap lg:justify-center'>
                        ...
                        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 1 }} className='w-full max-w-xl lg:w-3/4'>
                            ...
                            <p className='mb-4 text-neutral-200'> <span className='text-neutral-400 text-sm'> Collaborated in a team to design and develop three websites on the Wix platform within short time span,focusing on <a href='https://khadkaanamol87.wixsite.com/my-site-2' target='_blank' className='text-blue-400'>Education</a>, <a href='https://khadkaanamol87.wixsite.com/my-site-6' target='_blank' className='text-blue-400'>Residence</a>, and <a href='https://khadkaanamol87.wixsite.com/my-site-3' target='_blank' className='text-blue-400'>Artificial Intelligence</a> domains achieving <strong className='text-bold text-lg'>runner-up</strong> position</span></p>
                        </motion.div>
                    </div>
